...
namespace WorkshopHub.Infrastructure.Migrations
{
    ...
    [Migration("20250628011948_Modify-Remove-Schedule")]
    partial class ModifyRemoveSchedule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WorkshopHub.Domain.Entities.ActivityPointRule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9c052706-7218-4d52-a5ad-4e7071eba219"),
                            ActivityPoint = 10,
                            ActivityType = "AdtendWorkshop"
                        });
                });
            ...
            modelBuilder.Entity("WorkshopHub.Domain.Entities.Workshop", b =>
                {
                    ...
                    b.ToTable("Workshops", t =>
                        {
                            t.HasCheckConstraint("CK_Workshop_ScheduleStatus", "[ScheduleStatus] IN ('Pending', 'Starting', 'Ended')");
